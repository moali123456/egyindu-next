...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center font-sans dark:bg-black px-20">
      <h1>new app</h1>

      <h1 className="font-bold">{t("homePage.welcome_message")}</h1>
